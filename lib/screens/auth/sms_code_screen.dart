...
import 'package:film_fusion/controller/sms_code_controller.dart';
import 'package:flutter/material.dart';
import 'package:flutter_otp_text_field/flutter_otp_text_field.dart';
import 'package:get/get.dart';
...
class SmsCodeScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    SmsCodeController controller = Get.put(SmsCodeController());
    return Scaffold(
      resizeToAvoidBottomInset: false,
      body: Padding(
        padding: EdgeInsets.symmetric(horizontal: Get.height * .04),
        child: Column(
          ...
          children: [
            ...
            OtpTextField(
              ...
              showFieldAsBox: true,
              onCodeChanged: (String code) {
                controller.smsCodeController.text = code;
              },
              onSubmit: (String verificationCode) {
            ...
            Center(
              child: InkWell(
                onTap: () => controller.verifySmsCode(
